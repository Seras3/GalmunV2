...
namespace Galmun_V2
{
    public partial class Form1 : Form
    {
        ...
        void InitializareMain()
        {
            ...
            nrDivInfo.Font = NumeDInfo.Font = TaraInfo.Font = new Font(pfc.Families[0], 20);
            ...
            VS.Font = new Font(pfc.Families[0], 20);
            ...
            Deaths1.Font = new Font(pfc.Families[0], 12);
            ...
            U.Font = new Font(pfc.Families[0], 20);
            U.Text = "Tara" + '\n' + "(" + "Provincie" + ")" + '\n' + "Nr.Div";
